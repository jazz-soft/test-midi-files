...
smf.push(trk0);
trk0.smfSeqName('Multi-channel chords Test 3')
  .smfCopyright('https://jazz-soft.net')
  .smfText('A format 1 file with two tracks sharing a channel.\n')
  ...
  .smfText(' Now you must hear a chord at B5!')
...
smf.push(trk1);
trk1
  .noteOn(1, 'E5', 127).tick(96).noteOff(1, 'E5')
  .noteOn(1, 'F5', 127).tick(96).noteOff(1, 'F5')
  .noteOn(1, 'G5', 127).tick(96).noteOff(1, 'G5')
  .noteOn(1, 'A5', 127).tick(96).noteOff(1, 'A5')
  .noteOn(1, 'B5', 127).tick(96).noteOff(1, 'B5')
  .noteOn(1, 'C6', 127).tick(96).noteOff(1, 'C6')
  .noteOn(1, 'D6', 127).tick(96).noteOff(1, 'D6')
  .noteOn(1, 'E6', 127).tick(96).noteOff(1, 'E6');
var trk2 = new JZZ.MIDI.SMF.MTrk();
smf.push(trk2);
trk2
    .noteOn(0, 'G5', 127).tick(96).noteOff(0, 'G5')
    .noteOn(0, 'A5', 127).tick(96).noteOff(0, 'A5')
    .noteOn(0, 'B5', 127).tick(96).noteOff(0, 'B5')
    .noteOn(0, 'C6', 127).tick(96).noteOff(0, 'C6')
    .noteOn(0, 'D6', 127).tick(96).noteOff(0, 'D6')
    .noteOn(0, 'E6', 127).tick(96).noteOff(0, 'E6')
    .noteOn(0, 'F6', 127).tick(96).noteOff(0, 'F6')
    .noteOn(0, 'G6', 127).tick(96).noteOff(0, 'G6');
TEST.write(smf);
TEST.play(smf);
