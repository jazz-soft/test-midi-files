...
var insert = '\xfa\x00\x90\x3c\x7f';
...
smf.push(trk);
trk.smfSeqName('Illegal MIDI message: fa')
  .smfCopyright('https://jazz-soft.net')
  .smfText('This file contains illegal MIDI message: fa (Start). Most players consider it invalid.\n')
