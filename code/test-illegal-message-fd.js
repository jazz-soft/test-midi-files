...
var insert = '\xfd\x00\x90\x3c\x7f';
...
smf.push(trk);
trk.smfSeqName('Illegal MIDI message: fd')
  .smfCopyright('https://jazz-soft.net')
  .smfText('This file contains illegal MIDI message: fd (Undefined). Most players consider it invalid.\n')
