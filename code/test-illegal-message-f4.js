...
var insert = '\xf4\x00\x90\x3c\x7f';
...
smf.push(trk);
trk.smfSeqName('Illegal MIDI message: f4')
  .smfCopyright('https://jazz-soft.net')
  .smfText('This file contains illegal MIDI message: f4 (Undefined). Most players consider it invalid.\n')
