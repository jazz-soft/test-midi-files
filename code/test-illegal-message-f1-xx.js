...
var insert = '\xf1\x7f\x00\x90\x3c\x7f';
...
smf.push(trk);
trk.smfSeqName('Illegal MIDI message: f1 xx')
  .smfCopyright('https://jazz-soft.net')
  .smfText('This file contains illegal MIDI message: f1 xx (MIDI Time Code). Most players consider it invalid.\n')
