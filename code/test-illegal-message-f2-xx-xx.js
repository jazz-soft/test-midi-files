...
var insert = '\xf2\x7f\x7f\x00\x90\x3c\x7f';
...
smf.push(trk);
trk.smfSeqName('Illegal MIDI message: f2 xx xx')
  .smfCopyright('https://jazz-soft.net')
  .smfText('This file contains illegal MIDI message: f2 xx xx (Song Position). Most players consider it invalid.\n')
