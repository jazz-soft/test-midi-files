...
smf.push(trk);
trk.tick(tt).smfSeqName('2-Byte VLQ')
  .smfCopyright('https://jazz-soft.net')
  .smfText('This file has 2-byte VLQ delta times. Technically, it\'s a valid MIDI file.\n')
...
var data = smf.dump();
while (data.indexOf('\xf0') != -1) {
  data = data.replace('\xf0', '\x80');
}
