...
var insert = '\xfc\x00\x90\x3c\x7f';
...
smf.push(trk);
trk.smfSeqName('Illegal MIDI message: fc')
  .smfCopyright('https://jazz-soft.net')
  .smfText('This file contains illegal MIDI message: fc (Stop). Most players consider it invalid.\n')
