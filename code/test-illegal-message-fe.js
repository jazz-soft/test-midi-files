...
var insert = '\xfe\x00\x90\x3c\x7f';
...
smf.push(trk);
trk.smfSeqName('Illegal MIDI message: fe')
  .smfCopyright('https://jazz-soft.net')
  .smfText('This file contains illegal MIDI message: fe (Active Sensing). Most players consider it invalid.\n')
