...
var insert = '\xf6\x00\x90\x3c\x7f';
...
smf.push(trk);
trk.smfSeqName('Illegal MIDI message: f6')
  .smfCopyright('https://jazz-soft.net')
  .smfText('This file contains illegal MIDI message: f6 (Tune Request). Most players consider it invalid.\n')
