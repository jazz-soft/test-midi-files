...
var insert = '\xfb\x00\x90\x3c\x7f';
...
smf.push(trk);
trk.smfSeqName('Illegal MIDI message: fb')
  .smfCopyright('https://jazz-soft.net')
  .smfText('This file contains illegal MIDI message: fb (Continue). Most players consider it invalid.\n')
